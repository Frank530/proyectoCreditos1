...
public class CategoriaBean {
    ...
    @PostConstruct
    public void init(){
        categorias = categoriaRest.buscarTodos();
    ...
    public String eliminar(Categoria categoria){
        categoriaRest.elminar(categoria.getId());
        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(categoria.getDescripcion(),  "Se ha eliminado correctamente") );
        init();
        return null;
    }
...
//    }
    ...
    public String actualizar(RowEditEvent event){
        ...
        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage("Se ha actualizado correctamente "+categoria.getDescripcion()) );
        categoriaRest.actualizar(categoria);
        init();
        return null;
    }
